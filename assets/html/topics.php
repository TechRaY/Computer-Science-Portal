  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 ">
          <div class="grid mask">
            <figure> <img class="img-responsive" src="../img/portfolio/folio07.jpg" alt="">
              <figcaption>
                <h5>Databases</h5>
                <a  href="#" class="btn btn-default">Enter</a> </figcaption>
              <!-- /figcaption -->
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive" src="../img/portfolio/folio08.jpg" alt="">
              <figcaption>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive" src="../img/portfolio/folio09.jpg" alt="">
              <figcaption>
                <h5>Java</h5>
                <a  href="#" class="btn btn-default">Enter</a> </figcaption>
              <!-- /figcaption -->
