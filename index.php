  ...
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#home"><i class="fa fa-location-arrow"></i> ComputerScience Monks</a> </div>
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="#home" class="smoothScroll">Home</a></li>
          <li> <a href="#portfolio" class="smoothScroll"> Topics</a></li>
        ...
        <div class="col-md-4">
          <div class="grid mask">
            <figure> <img class="img-responsive" src="assets/img/portfolio/folio02.jpg" alt="">
              <figcaption>
                <h5>Company Interview Questions</h5>
...
<div id="about" name="about">
  <div class="container">
    <div class="row white">
      ...
      <div class="col-md-6">
        <h3>About us</h3>
        <p>A complete portal for Computer Science fanatic.</p>
        <h3>Why choose us?</h3>
        <p>The content for this website is taken from many other websites.<br>LOL</p>
      </div>
    </div>
    <!-- row -->
  </div>
...
<div id="team" name="team">
  <div class="container">
    <div class="row centered">
      ...
      <hr>
      <div class="col-lg-4 centered"> <img class="img img-circle" src="assets/img/team/rahul.jpg" height="120px" width="120px" alt="">
        <h4>Rahul Shetty</h4>
        <p>Developer</p>
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> </div>
      <div class="col-lg-4 centered"> <img class="img img-circle" src="assets/img/team/rajeev.jpg" height="120px" width="120px" alt="">
        <h4>Rajeevkumar Yadav</h4>
        <p>Developer</p>
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4"> <i class="fa fa-envelope-o fa-2x"></i>
        <p>info@computersciencemonks.com</p>
      </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 centered">
        <p><h3>We'll sooner contact you.</h3></p>
...
<div id="footerwrap">
  <div class="container">
    <div class="row">
      <div class="col-md-8"> <span class="copyright">Copyright &copy; friends.group. Design by rrrm@company</div>
      <div class="col-md-4">
